...
Answer "1" if the step was already completed, otherwise "0". 
Do not answer with a paragraph. You must answer with "0" or "1" only."""
    },
    2: {
        "Interleaved": 
            """You are a technical assistant expert in furniture assembly.
...
You must answer with '1' or '0' only.""",
        "Non-Interleaved": 
            """You are a technical assistant expert in furniture assembly.
Your task is to determine if the observed frame matches a step in the instruction manual.

The left side of the image shows a frame from the assembly process, and the right side shows an instruction manual page.

Answer "1" if the frame corresponds to one of the steps in the manual page. Answer "0" if it does not.
Do not answer with a paragraph. You must answer with "1" or "0" only."""
    },
    3: {
        "Interleaved": 
            """You are a technical assistant expert in furniture assembly.
...
Instruction manual pages: {img_placeholder}

Analyze the observed frames and provide the number of the assembly step being performed.
Do not answer with a paragraph. You must answer with a single step number.""",
        "Non-Interleaved": 
            """You are a technical assistant expert in furniture assembly.
Your task is to identify the step number from the instruction manual that matches the action shown in the observed frames.
...
Do not answer with a paragraph. You must answer with a step number only."""
    }
}
